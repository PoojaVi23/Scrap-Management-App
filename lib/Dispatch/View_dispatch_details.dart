        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                /// Top Row (Invoice + Edit Button)
                Row(
                  children: [
                    Icon(Icons.receipt_long_rounded, color: Colors.indigo, size: 28),
                    SizedBox(width: 10),
                    Expanded(
                      child: Text(
                        "Invoice: ${index['invoice_no']}",
                ...
                Row(
                  children: [
                    Icon(Icons.inventory_2, color: Colors.deepPurple, size: 22),
                    SizedBox(width: 10),
                    Text(
                      "Material: ${index['material_name']}",
                      style: TextStyle(
                ...
                Row(
                  children: [
                    Icon(Icons.calendar_month, color: Colors.deepOrange, size: 22),
                    SizedBox(width: 10),
                    Text(
                      "Date: ${formatDate(index['date_time'])}",
                      style: TextStyle(
                ...
                Row(
                  children: [
                    Icon(Icons.local_shipping, color: Colors.teal.shade800, size: 22),
                    SizedBox(width: 10),
                    Text(
                      "Dispatch By: ${index['person_name']}",
                      style: TextStyle(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            index['user_status'] == 'p'
                                ? "User Dispatch Pending"
                                : "User Dispatch Completed",
                            style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                              color: Colors.white,
                    ...
                    /// Spacer
                    if (userType != 'U') SizedBox(height: 8),
